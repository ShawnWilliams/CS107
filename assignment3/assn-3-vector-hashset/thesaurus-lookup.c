...
int main(int argc, const char *argv[])
{
  ...
  //const char *thesaurusFileName = (argc == 1) ? "/usr/class/cs107/assignments/assn-3-vector-hashset-data/thesaurus.txt" : argv[1];
  const char *thesaurusFileName = (argc == 1) ? "/home/shawn/桌面/CS107/assignment3/assn-3-vector-hashset-data/thesaurus.txt" : argv[1];
